...
$songs = [
  "Die with a smile" => ["file" => "songs/dwas.mp3", "image" => "images/dwas.jpeg"],
  "Kanima" => ["file" => "songs/Kanima.mp3", "image" => "images/kanima.jpeg"],
  "Unstoppable" => ["file" => "songs/unstoppable.mp3", "image" => "images/unstoppable.jpeg"]
];
...
<body class="bg-gradient-to-br from-purple-700 via-pink-600 to-yellow-500 text-white min-h-screen font-sans">
  ...
  <h1 class="text-5xl font-bold text-cyan-400 mb-8 drop-shadow-md" id="alname">🎧 Synthwave Album</h1>
