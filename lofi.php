...
$songs = [
  "Dandelions" => ["file" => "songs/dandelions.mp3", "image" => "images/dandelions.jpg"],
  "Hosanna" => ["file" => "songs/hosanna.mp3", "image" => "images/hosanna.jpeg"],
  "Perfect" => ["file" => "songs/perfect.mp3", "image" => "images/perfect.jpeg"]
];
...
<body class="bg-gradient-to-br from-purple-700 via-pink-600 to-yellow-500 text-white min-h-screen font-sans">
  ...
  <h1 class="text-5xl font-bold text-cyan-400 mb-8 drop-shadow-md" id="alname">🌙 Lofi Album</h1>
